 ...
 * Version : V 1.0
 */
public class MapFrameLayout extends FrameLayout implements View.OnClickListener, IMapView {
   ...
   // private IMapView mapView;
    ...
    public void zoomInFinish() {
        tvMapNotice.setText(context.getResources().getString(R.string.zoom_in_success));
    }

    /** 缩小地图 **/
    @Override
    public void zoomOutFinish() {
        tvMapNotice.setText(context.getResources().getString(R.string.zoom_out_success));
    }
